    ...
    return (
      <div className="text-center py-16 flex flex-col items-center gap-6">
        ...
        <Button
          ...
          className="bg-gold text-navy font-semibold hover:bg-gold-light rounded-none px-10 py-5 text-sm tracking-wide gap-2 mt-4"
        >
      ...
      <div className="flex items-center justify-between mt-10 pt-8 border-t border-border">
        ...
        {step < TOTAL_STEPS ? (
          <Button
            onClick={() => setStep((s) => s + 1)}
            disabled={!canNext()}
            className="bg-gold text-navy font-semibold hover:bg-gold-light disabled:opacity-40 disabled:cursor-not-allowed rounded-none px-8 py-4 text-sm tracking-wide gap-2 transition-all"
          >
            Weiter
            <ArrowRight size={14} />
          </Button>
